    ...
    public function getPreselectOptionId()
    {
        ...
        if ($this->getPreselectSource()==0) {
            ...
            if (!$this->getProduct()->getIsDefaultSelected()) {
                ...
                $selectedOpt = [];
                $product = $objectManager->create('Magento\Catalog\Model\Product')->load($this->getProduct()->getIsDefaultSelected());
            ...
            if (!empty($productpricearray) && count(array_unique($productpricearray)) === 1) {
                ...
                $selectedOpt = [];
                $product = $objectManager->create('Magento\Catalog\Model\Product')->load($maxpriceproductid);
            ...
            if (!empty($productpricearray) && count(array_unique($productpricearray)) === 1) {
                ...
                $selectedOpt = [];
                $product = $objectManager->create('Magento\Catalog\Model\Product')->load($lowpriceproductid);
