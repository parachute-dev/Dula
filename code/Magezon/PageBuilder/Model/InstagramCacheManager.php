...
class InstagramCacheManager implements \Psr\SimpleCache\CacheInterface
{
    /**
     * Prefix for cache key of block
     */
    const CACHE_KEY_PREFIX = 'MAGEZON_INSTAGRAM_';
    ...
    {
    	//$this->getCacheManager()->remove($key);
    }
    ...
    {
    	return $this->getCacheManager()->load($key);
    }
